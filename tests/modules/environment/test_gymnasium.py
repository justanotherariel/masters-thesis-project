...
from src.modules.environment.gymnasium import GymnasiumBuilder, GymnasiumSamplerRandom, MinigridSamplerExtensive, flatten_indices
...
def test_gymnsasium_sampler_random():
    ...
    sampler = GymnasiumSamplerRandom(num_samples=num_samples, num_samples_per_env=num_samples_per_env, perc_train=perc_train)
